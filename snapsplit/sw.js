const CACHE='snapsplit-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js','./sw.js','./fixtures/simple-diner.txt','./fixtures/family-style.txt','./fixtures/weighted-party.txt'];
